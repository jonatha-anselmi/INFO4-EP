...
We consider the [KIT dataset](https://github.com/jonatha-anselmi/INFO4-EP/blob/main/datasets/KIT.txt).
...
Nonetheless, the crude approximation above does not produce bad results, the analytical approximation is not far from the optimal one.


### [HOMEWORK] Add real service times

Use the KIT dataset and repeat the analysis above including service times.
